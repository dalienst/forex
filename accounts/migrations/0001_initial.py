    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='admin_image')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='client_image')),
                ('phone_number', models.PositiveIntegerField(blank=True, null=True)),
                ('identification', models.PositiveIntegerField(blank=True, null=True)),
            ],
            options={
                'abstract': False,
            },
